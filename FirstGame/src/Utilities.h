...
static void draw3Dline(const glm::vec3& p1, const glm::vec3& p2, const glm::vec3& color, std::vector<std::pair<std::string, Shader>>& shaders, Camera& cam)
{
	...
	glm::mat4 projection = glm::perspective(glm::radians(cam.Zoom), (float)1600.0f / (float)800.0f, 0.1f, 2000.0f);
...
static void draw2Dline(const glm::vec2& p1, const glm::vec2& p2, const glm::vec3& color, std::vector<std::pair<std::string, Shader>>& shaders)
{
	GLfloat vertices[] = {
		 p1.x, p1.y, 0.0f,
		 p2.x, p2.y, 0.0f
...
static void drawSquare(glm::vec3& center, std::vector<std::pair<std::string, Shader>>& shaders, Camera& cam)
{
	//draw3Dline(glm::vec3(0.0,0.0,0.0), glm::vec3(100.0, 0.0, 0.0), glm::vec3(1.0f, 1.0f, 1.0f), shaders, cam);
	draw2Dline(glm::vec2(0.0f, 0.0f), glm::vec2(1.0f, 1.0f), glm::vec3(1.0f, 1.0f, 1.0f), shaders);
	/*
	glm::vec3 topLeft  = glm::vec3(center.x - 20.0f, center.y, center.z - 20.0f);
	glm::vec3 topRight = glm::vec3(center.x - 20.0f, center.y, center.z + 20.0f);
	draw3Dline(topLeft, topRight, glm::vec3(1.0f, 0.0f, 0.0f), shaders, cam);

	glm::vec3 botLeft  = glm::vec3(center.x - 20.0f, center.y, center.z - 20.0f);
	glm::vec3 botRight = glm::vec3(center.x - 20.0f, center.y, center.z + 20.0f);
	draw3Dline(botLeft, botRight, glm::vec3(1.0f, 0.0f, 0.0f), shaders, cam);

	draw3Dline(topLeft,  botLeft,  glm::vec3(1.0f, 0.0f, 0.0f), shaders, cam);
	draw3Dline(topRight, botRight, glm::vec3(1.0f, 0.0f, 0.0f), shaders, cam);
	*/
}